    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                filter.pageSize =10;
                this.$ajax.postu(urlA+'/permission/listPermissionPage', filter).then((res) => {
                    if (res.msg == "success") {
            ...
            saveEdit() {
                   if(this.isAdd===false){
                     ...
                     this.$ajax.postu(urlA+'account/addAccountInfo',this.form).then((res) => {
                        if (res.msg == "success") {
                    ...
                    this.$ajax.postu(urlA+'account/updateAccountInfo',params).then((res) => {
                        if (res.msg == "success") {
