...
<script>
    export default {
        ...
        methods: {
            getDealer(arr){
                var params = {};
                params.account_id = arr;
               this.$ajax.postu(urlA+'weixinAuth/getShopId',params).then((res) => {
                            if (res.msg == "success") {
                                // 如果是B端 缓存店铺id
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        // this.$router.push('/');
                        this.$ajax.postu(urlA+'sys/login', this.ruleForm).then((res) => {
                            if (res.msg == "success") {
                              ...
                              this.getDealer(res.data.accountInfo.account_id)
