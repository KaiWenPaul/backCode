    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="form.templateId" placeholder="活动编号" class="handle-input mr10"  @keyup.enter.native="search"></el-input>
                <el-input v-model="form.goodsName" placeholder="商品名称" class="handle-input mr10" @keyup.enter.native="search"></el-input>
                <el-input v-model="form.goodsarray" placeholder="商品ID" class="handle-input mr10" @keyup.enter.native="search"></el-input> 
                <el-input v-model="form.brandId" placeholder="品牌ID" class="handle-input mr10" @keyup.enter.native="search"></el-input>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                 ...
                 this.$ajax.postu('distributor/activitystatistics/selectStatistics', this.filter).then((res) => {
            ...
            getListData(){
                 ...
                 this.filter.templateId = this.form.templateId;
                 this.filter.goodsarray = this.form.goodsarray;
                 this.$ajax.postu('distributor/activitystatistics/select', this.filter).then((res) => {
                    if (res.description == "success") {
