        ...
        methods: {
            getData(){
                ...
                //   filter.limit =10;
                 ...
                 this.$ajax.postu('/statecoupon.api?selectByPrimaryKey',filter).then((res) => {
                    if (res.status == "ok") {
            ...
            saveAdd(){
                ...
                this.$ajax.postu('/statecoupon.api?insert',this.addForm).then((res) => {
                    if (res.status == "ok") {
            ...
            saveEdit() {
                ...
                this.form.couponId = this.couponId;
                 this.$ajax.postu('statecoupon.api?updateByPrimaryKeySelective',this.form).then((res) => {
                    if (res.status == "ok") {
            ...
            handleDelete(index, row) {
              ...
              // 确定删除
            deleteRow(){
                this.$ajax.postu('/statecoupon.api?delete',{id:this.idx}).then((res) => {
                    if (res.status == "ok") {
            ...
            delAll() {
               ...
               this.$ajax.postu('/distributor/tstdistributorgoods.api?doRemoveeMore',{arr:strs}).then((res) => {
