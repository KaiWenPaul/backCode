                ...
                <el-table-column  label="抵扣条件" align="center">
                     <template slot-scope="scope">
                        <span v-if="scope.row.couponDeduction == '0'">所有商品</span>  
                         <span v-else-if="scope.row.couponDeduction == '1'">特定商品</span>
                        <span v-else>{{scope.row.couponDeduction}}</span>
                   </template>
                </el-table-column>
                <el-table-column label="终端" align="center">
                   <template slot-scope="scope">
                        <span v-if="scope.row.userShop == '0'">用户</span>  
                         <span v-else-if="scope.row.userShop == '1'">店铺</span>
                        <span v-else>{{scope.row.userShop}}</span>
                   </template>
                </el-table-column>
        ...
        <el-dialog :title="title" :visible.sync="editVisible" width="50%">
             <el-form ref="form" :model="form" label-width="100px" style="width:600px;">
                    ...
                    <el-form-item label="类型">
                        <el-radio v-model="form.userShop" label="0">用户</el-radio>
                        <el-radio v-model="form.userShop" label="1">店铺</el-radio>
                    </el-form-item>
                    <el-form-item label="日期时间">
                        <el-col :span="11">
                            <el-date-picker type="datetime" value-format="yyyy/MM/dd HH:mm:ss" placeholder="开始时间" v-model="form.couponStarttime" style="width: 100%;"></el-date-picker>
                        </el-col>
                        <el-col class="line" :span="2" align="center">-</el-col>
                        <el-col :span="11">
                            <el-date-picker  type="datetime" value-format="yyyy/MM/dd HH:mm:ss"  placeholder="结束时间" v-model="form.couponEndtime" style="width: 100%;"></el-date-picker>
                        </el-col>
                    </el-form-item>
                    <el-form-item>
        ...
        methods: {
            ...
            getData(arr) {
                ...
                filter.userId = this.userId;
                 ...
                 this.$ajax.postu(urlA+'yzb/couponhave/listPage',filter).then((res) => {
                    if (res.msg == "success") {
            ...
            handleEdit(index, row,arr) {
                ...
                if(arr==1){
                   ...
                   this.form={
                     ...
                     userShop:row.userShop.toString(),
            ...
            saveEdit() {
                if(this.isAdd===false){
                    ...
                    this.$ajax.postu(urlA+'yzb/couponhave/update',this.form).then((res) => {
                    if (res.msg == "success") {
                    ...
                    this.$ajax.postu(urlA+'yzb/couponhave/insert',this.form).then((res) => {
                    if (res.msg == "success") {
