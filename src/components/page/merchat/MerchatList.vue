        ...
        <div class="container">
           ...
           <div class="handle-box add">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="phone" label="店铺电话" align="center"></el-table-column>
                ...
                <el-table-column label="logo" align="center">
                  <template slot-scope="scope">
                    <img  :src="imgUrl+scope.row.logo" alt="" style="width: 50px;height: 50px">
                  </template>
                </el-table-column>
       ...
       <!-- 查看弹出框 -->
        <el-dialog title="查看详情" :visible.sync="listVisible" width="50%">
             <el-form ref="form" :model="form" label-width="100px" style="width:600px;">
                    ...
                    <el-form-item label="店铺电话"><el-input v-model="form.phone" :disabled="true"></el-input></el-form-item>
                    <el-form-item label="店铺地址"><el-input v-model="form.address" :disabled="true"></el-input></el-form-item>
                    <el-form-item label="联系电话"><el-input v-model="form.phoneNumber" :disabled="true"></el-input></el-form-item>
                    <el-form-item label="店铺微信"><el-input v-model="form.wechatNumber" :disabled="true"></el-input></el-form-item>
                    <el-form-item label="店铺logo"><img  :src="imgUrl+form.logo" alt="" style="width: 50px;height: 50px"></el-form-item>
                </el-form>
        </el-dialog>
             ...
             <el-form ref="form" :model="form" label-width="100px" style="width:600px;">
                    ...
                    <el-form-item label="logo">
                        <!--<el-upload
                         ...
                         <img  :src="imgUrl+form1.logo" alt="" style="width: 80px;height: 80px;">
                    </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            getData(arr) {
                ...
                this.$ajax.postu(urlA+'yzb/shop/listShopPage', filter).then((res) => {
                    if (res.msg == "success") {
            ...
            saveEdit() {
                if(this.isAdd===false){
                   ...
                   this.$ajax.postu(urlA+'yzb/shop/update',this.form1).then((res) => {
                    if (res.msg == "success") {
                   ...
                   this.form1.logo=this.moveImage;
                   this.$ajax.postu(urlA+'yzb/shop/insert',this.form1).then((res) => {
                    if (res.msg == "success") {
